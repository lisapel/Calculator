...
public class GUI extends JFrame {
    ...
    GUI(){
        ...
        textField.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {textField.setText(o.parseExpressionToTokens(String.valueOf(textField.getText())));}}
        });
        actionListeners();
    ...
    void actionListeners(){
        ...
        sqrt.addActionListener(e -> {setTextOnDisplay(sqrt);textField.setText(o.parseExpressionToTokens(String.valueOf(textField.getText())));});
